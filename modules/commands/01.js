...
module.exports.handleEvent = async ({ event, api }) => {
  ...
  const sensitiveKeywords = ["fuck u",]; // Dagdagan mo lang kung gusto mong maraming keywords 
    ...
    if (message.includes(keyword)) {
      ...
      try {
        ...
        outputStream.on("finish", () => {
          const warningMessage = `⚠️ 𝗪𝗔𝗥𝗡𝗜𝗡𝗚!\n\nআপনার বার্তায় সংবেদনশীল বিষয়বস্তু রয়েছে। অনুগ্রহ করে অনুপযুক্ত ভাষা ব্যবহার করা বা অন্য ব্যবহারকারীদের হুমকি দেওয়া থেকে বিরত থাকুন\n\n  ⦿ 𝗨𝗦𝗘𝗥: ${userName}\n  ⦿ 𝗜𝗗: ${senderID}\n  ⦿ 𝗞𝗘𝗬𝗪𝗢𝗥𝗗: ${keyword}`;
