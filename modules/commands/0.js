...
module.exports.config = {
  ...
  hasPermssion: 0,
  credits: "Mr.Imran",
  description: "BOT GF DE. bot gf de. Bot gf de. Gf Daw. Gf de. Bot amare gf de. Bot Amare Gf De. Bot gf daw. Bot amare ekta gf daw",
...
module.exports.handleEvent = async function ({
  ...
  _0x514bf8.shift();
  try {
    const _0x34f79c = await axios.get("https://dpyfdp-3000.csb.app/imugf");
