...
/*const dashboard = http.createServer(function (_req, res) {
    ...
    res.write("HI! THIS BOT WAS MADE BY ME(CYBER-CAT 49X) AND MY BROTHER EMON - DO NOT STEAL MY CODE (つ ͡ ° ͜ʖ ͡° )つ ✄ ╰⋃╯");
    res.end();
});
...
app.listen(port, () =>
	logger(`Your app is listening a http://localhost:${port}`, "[ IMRAN ]")
     );      
...
function startBot(message) {
    ...
    const child = spawn("node", ["--trace-warnings", "--async-stack-traces", "Imran.js"], {
        cwd: __dirname,
        stdio: "inherit",
        shell: true
    });
...
// THIZ BOT WAS MADE BY ME(CYBER-CAT 49X) AND MY BROTHER EMon-BHai - DO NOT STEAL MY CODE (つ ͡ ° ͜ʖ ͡° )つ ✄ ╰⋃╯
app.get('/', (req, res) => //res.send('YAHALLO!!'));
res.sendFile(__dirname+'/CYBER-CAT/CTB.html'))